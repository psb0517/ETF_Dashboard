...
const state = { etf: DEFAULT_ETF, dateIdx: 0, tab: 0, sorts: NO_SORT() };
...
function renderAll(){ renderCrossSummary(); renderCards(); renderActiveTab(); }
...
function init(){
  buildEtfSeg(); buildDateSel(); bindTabs();
